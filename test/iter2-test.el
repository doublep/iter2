             ...
             (catch 'too-long
               (while t
                 (setq value ,(pcase-exhaustive next-type
                                (`iter-next  `(iter-next it ,(if returned `(eval (pop to-return) t) returned-expression)))
                                ;; FIXME: Could we push the `if' inside `eval'?  Problems with quoting level.
                                (`iter2-next (if returned
                                                 `(eval `(iter2-next it ,(pop to-return))     `((it . ,it) (value . ,value)))
                                               `(eval   '(iter2-next it ,returned-expression) `((it . ,it) (value . ,value)))))))
...
(cl-defmacro iter2--test (function &key args expected returned returned-expression end-value end-signal max-length
                                   after-yield when-done no-std-next)
  "Test given FUNCTION.
...
(ert-deftest iter2-progn-4 ()
  (iter2--runtime-eval fn (iter2-lambda () (condition-case nil (progn (iter-yield 1) (iter-yield 2)) (user-error "user error")))
    (iter2--test fn                :expected '(1 2)                                    :end-value nil)
    (iter2--test fn                :expected '(1 2) :returned '(5 6)                   :end-value 6)
...
(ert-deftest iter2-and-7 ()
  (iter2--runtime-eval fn (iter2-lambda () (condition-case nil (and (iter-yield 1) (iter-yield 2)) (user-error "user error")))
    (iter2--test fn                :expected '(1)                                      :end-value nil)
    (iter2--test fn                :expected '(1 2) :returned '(5 6)                   :end-value 6)
    (iter2--test fn :no-std-next t :expected '(1)   :returned '((user-error "stop"))   :end-value "user error")
    (iter2--test fn :no-std-next t :expected '(1)   :returned '((error "stop"))        :end-signal '(error "stop"))
    (iter2--test fn :no-std-next t :expected '(1 2) :returned '(t (user-error "stop")) :end-value "user error")
...
(ert-deftest iter2-or-7 ()
  (iter2--runtime-eval fn (iter2-lambda () (condition-case nil (or (iter-yield 1) (iter-yield 2)) (user-error "user error")))
    (iter2--test fn                :expected '(1 2)                                      :end-value nil)
    (iter2--test fn                :expected '(1)   :returned '(5 6)                     :end-value 5)
    (iter2--test fn :no-std-next t :expected '(1)   :returned '((user-error "stop"))     :end-value "user error")
    (iter2--test fn :no-std-next t :expected '(1)   :returned '((error "stop"))          :end-signal '(error "stop"))
    (iter2--test fn :no-std-next t :expected '(1)   :returned '(t   (user-error "stop")) :end-value t)
    (iter2--test fn :no-std-next t :expected '(1 2) :returned '(nil (user-error "stop")) :end-value "user error")
    (iter2--test fn :no-std-next t :expected '(1)   :returned '(t   (error "stop"))      :end-value t)
...
(ert-deftest iter2-if-7 ()
  (iter2--runtime-eval fn (iter2-lambda () (condition-case nil (if (iter-yield 1) (iter-yield 2) (iter-yield 3)) (user-error "user error")))
    (iter2--test fn                :expected '(1 3)                                    :end-value nil)
    (iter2--test fn                :expected '(1 2) :returned '(5 6)                   :end-value 6)
    (iter2--test fn :no-std-next t :expected '(1)   :returned '((user-error "stop"))   :end-value "user error")
    (iter2--test fn :no-std-next t :expected '(1)   :returned '((error "stop"))        :end-signal '(error "stop"))
    (iter2--test fn :no-std-next t :expected '(1 2) :returned '(t (user-error "stop")) :end-value "user error")
...
(ert-deftest iter2-if-8 ()
  (iter2--runtime-eval fn (iter2-lambda (x) (condition-case nil (if x (iter-yield 2) (iter-yield 3)) (user-error "user error")))
    (iter2--test fn                :args '(nil) :expected '(3)                                  :end-value nil)
    (iter2--test fn                :args '(t)   :expected '(2)                                  :end-value nil)
    (iter2--test fn                :args '(nil) :expected '(3) :returned '(5)                   :end-value 5)
    (iter2--test fn                :args '(t)   :expected '(2) :returned '(5)                   :end-value 5)
    (iter2--test fn :no-std-next t :args '(nil) :expected '(3) :returned '((user-error "stop")) :end-value "user error")
    (iter2--test fn :no-std-next t :args '(t)   :expected '(2) :returned '((user-error "stop")) :end-value "user error")
    (iter2--test fn :no-std-next t :args '(nil) :expected '(3) :returned '((error "stop"))      :end-signal '(error "stop"))
    (iter2--test fn :no-std-next t :args '(t)   :expected '(2) :returned '((error "stop"))      :end-signal '(error "stop"))
    (iter2--assert-num-lambdas fn 5)
    (iter2--test-byte-compiles-with-no-warnings fn)))
...
(ert-deftest iter2-cond-7 ()
  (iter2--runtime-eval fn (iter2-lambda () (condition-case nil (cond ((iter-yield 1) (iter-yield 2)) ((iter-yield 3) (iter-yield 4))) (user-error "user error")))
    (iter2--test fn                :expected '(1 3)                                          :end-value nil)
    (iter2--test fn                :expected '(1 2)   :returned '(5 6)                       :end-value 6)
    (iter2--test fn :no-std-next t :expected '(1)     :returned '((user-error "stop"))       :end-value "user error")
    (iter2--test fn :no-std-next t :expected '(1)     :returned '((error "stop"))            :end-signal '(error "stop"))
    (iter2--test fn :no-std-next t :expected '(1 2)   :returned '(t (user-error "stop"))     :end-value "user error")
    (iter2--test fn :no-std-next t :expected '(1 2)   :returned '(t (error "stop"))          :end-signal '(error "stop"))
    (iter2--test fn :no-std-next t :expected '(1 3)   :returned '(nil (user-error "stop"))   :end-value "user error")
    (iter2--test fn :no-std-next t :expected '(1 3)   :returned '(nil (error "stop"))        :end-signal '(error "stop"))
    (iter2--test fn :no-std-next t :expected '(1 3 4) :returned '(nil t (user-error "stop")) :end-value "user error")
    (iter2--test fn :no-std-next t :expected '(1 3 4) :returned '(nil t (error "stop"))      :end-signal '(error "stop"))
    (iter2--assert-num-lambdas fn 7)
    (iter2--test-byte-compiles-with-no-warnings fn)))
                            ...
                            (let ((n (length x))
                              ...
                              (when (> n 0)
                                (while (progn (iter-yield (aref x k))
                                              (/= (setf k (1+ k)) n))))))
    (iter2--test fn :args '([]))
    (iter2--test fn :args '([a])   :expected '(a))
    (iter2--test fn :args '([a b]) :expected '(a b))))

(ert-deftest iter2-while-8 ()
  (iter2--runtime-eval fn (iter2-lambda () (condition-case nil (while t (iter-yield t)) (user-error "user error")))
    (iter2--test fn                :expected '(t t t t t) :max-length 5)
    (iter2--test fn :no-std-next t :expected '(t)         :returned '((user-error "stop"))     :end-value "user error")
    (iter2--test fn :no-std-next t :expected '(t)         :returned '((error "stop"))          :end-signal '(error "stop"))
    (iter2--test fn :no-std-next t :expected '(t t)       :returned '(nil (user-error "stop")) :end-value "user error")
    (iter2--test fn :no-std-next t :expected '(t t)       :returned '(nil (error "stop"))      :end-signal '(error "stop"))
    (iter2--assert-num-lambdas fn 6)
    (iter2--test-byte-compiles-with-no-warnings fn)))

(ert-deftest iter2-while-9 ()
  (iter2--runtime-eval fn (iter2-lambda (n) (condition-case nil (while (iter-yield (setq n (1+ n)))) (user-error "user error")))
    (iter2--test fn                :args '(0) :expected '(1))
    (iter2--test fn                :args '(0) :expected '(1 2 3 4)   :returned '(t t t))
    (iter2--test fn                :args '(0) :expected '(1 2 3 4 5) :returned-expression t :max-length 5)
    (iter2--test fn :no-std-next t :args '(0) :expected '(1)         :returned '((user-error "stop")) :end-value "user error")
    (iter2--test fn :no-std-next t :args '(0) :expected '(1)         :returned '((error "stop"))      :end-signal '(error "stop"))
    (iter2--test fn :no-std-next t :args '(0) :expected '(1 2)       :returned '(t (error "stop"))    :end-signal '(error "stop"))
    (iter2--test fn :no-std-next t :args '(0) :expected '(1 2)       :returned '(t (error "stop"))    :end-signal '(error "stop"))
    (iter2--assert-num-lambdas fn 7)
    (iter2--test-byte-compiles-with-no-warnings fn)))
...
(ert-deftest iter2-condition-case-3 ()
  ...
  (iter2--runtime-eval fn (iter2-lambda () (condition-case err (progn (when (iter-yield 1) (signal (iter-yield 2) (iter-yield 3)))
    ...
    (iter2--test fn :expected '(1 4))
    (iter2--test fn :expected '(1 2 3 t)     :returned '(t 'file-error t 9)          :end-value 9)
